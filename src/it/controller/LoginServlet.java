    ...
    public LoginServlet() // default constructor
    {
        ...
        if(userValidate.equals("normal_user"))
         {	
        	 ...
        	 int id = loginBean.getIdcostumer();
             HttpSession session = request.getSession(true);
             session.setMaxInactiveInterval(10*60);
             session.setAttribute("id", loginBean.getIdcostumer());
             ...
             session.setAttribute("city", loginBean.getCity()); 
             session.setAttribute("cap", loginBean.getCap());
             session.setAttribute("ntel1", loginBean.getNtel1());
             ...
             System.out.println("Sessione per l'utente con ruolo "+loginBean.getRuolo()+": "+mails+" con id: "+id+" � stata creata con successo.");

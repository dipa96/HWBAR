...
/**
 * Servlet implementation class CartsetqntDetailsm
 */
@WebServlet("/CartsetqntDetailsm")
public class CartsetqntDetailsm extends HttpServlet {
		 ...
		 try {
				...
				ResultSet rs = ps.executeQuery();
	             ...
	             request.setAttribute("Message", "<div id=\"ServletMessage\" class=\"container center_div\" style=\" padding:15px;\">\n" + 
		             		"	<div class=\"alert alert-success\" role=\"alert\">Prodotto rimosso. </div>  </div>  ");
